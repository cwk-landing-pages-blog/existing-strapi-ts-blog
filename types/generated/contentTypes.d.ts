...
export interface ApiCodingTechCodingTech extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'coding techs';
    pluralName: 'coding-techs';
    singularName: 'coding-tech';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::coding-tech.coding-tech'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    react_icons_string: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiCwkUserCwkUser extends Struct.CollectionTypeSchema {
  collectionName: 'cwk_users';
  info: {
    description: '';
    displayName: 'CWK User';
    pluralName: 'cwk-users';
    singularName: 'cwk-user';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    isSoftDeleted: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cwk-user.cwk-user'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCwkCwk extends Struct.SingleTypeSchema {
  collectionName: 'cwks';
  info: {
    description: '';
    displayName: 'CWK';
  ...
  attributes: {
    about_me: Schema.Attribute.RichText &
      ...
      >;
    contact: Schema.Attribute.Component<'business.contact', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cwk.cwk'> &
      Schema.Attribute.Private;
    my_experience: Schema.Attribute.Component<'cwk.job-experience', true>;
    publishedAt: Schema.Attribute.DateTime;
    social_networks: Schema.Attribute.Component<'shared.social-networks', true>;
...
export interface ApiEndry2008Endry2008 extends Struct.SingleTypeSchema {
  collectionName: 'endry_2008s';
  info: {
    description: '';
    displayName: 'Endry 2008';
    pluralName: 'endry-2008s';
    singularName: 'endry-2008';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expert_flooring_installer: Schema.Attribute.Component<
    ...
    Hero: Schema.Attribute.Component<'business.hero', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    our_business_statistics: Schema.Attribute.Component<
      'business.statistics',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    publishedAt: Schema.Attribute.DateTime;
    Section: Schema.Attribute.DynamicZone<['blocks.section-title']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    services: Schema.Attribute.Component<'business.service-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    social: Schema.Attribute.Component<'shared.social-networks', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEndryClienteEndryCliente
  extends Struct.CollectionTypeSchema {
  collectionName: 'endry_clientes';
  info: {
    description: '';
    displayName: 'endry-cliente';
    pluralName: 'endry-clientes';
    singularName: 'endry-cliente';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::endry-cliente.endry-cliente'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    preventivs: Schema.Attribute.Relation<
      'manyToMany',
      'api::preventiv.preventiv'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGuestbookGuestbook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visitor: Schema.Attribute.Email & Schema.Attribute.Required;
  };
}

export interface ApiIdrizTravelUmraIdrizTravelUmra
  extends Struct.SingleTypeSchema {
  collectionName: 'idriz_travel_umras';
  info: {
    description: '';
    displayName: 'Idriz Travel Umra';
    pluralName: 'idriz-travel-umras';
    singularName: 'idriz-travel-umra';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    info: Schema.Attribute.Component<'idriz-umrah-block.info', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::idriz-travel-umra.idriz-travel-umra'
    > &
      Schema.Attribute.Private;
    oferta: Schema.Attribute.Component<'business.oferta', false>;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'business.service-light', true>;
    Title: Schema.Attribute.String;
...
export interface ApiPreventivItemPreventivItem
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::preventiv-item.preventiv-item'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    preventiv: Schema.Attribute.Relation<
      'manyToOne',
      'api::preventiv.preventiv'
    >;
...
export interface ApiPreventivPreventiv extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    endry_clientes: Schema.Attribute.Relation<
      'manyToMany',
      'api::endry-cliente.endry-cliente'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    preventiv_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::preventiv-item.preventiv-item'
    >;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<
      ['in-progress', 'done', 'accepted', 'declined']
    >;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUmrahTripUmrahTrip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    arriving: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departing: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    description: Schema.Attribute.Component<'blocks.rich-text', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    price: Schema.Attribute.Component<'idriz-umrah-block.umrah-price', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::endry-2008.endry-2008': ApiEndry2008Endry2008;
